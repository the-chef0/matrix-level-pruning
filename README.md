...
TODO:
 ...
 - [ ] There should be a way to make general DFS functions like `find_first_node_by_cond`, `collect_nodes_by_cond` and `count_nodes_by_cond` and pass the conditions as lambdas, but the work needed to make this kind of abstraction might not be worth it at all. Revisit this if it becomes relevant.
